...
@WebServlet("/out-of-band")
public class OutOfBandServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			content = "Processed XML";
			
        } catch (Exception e) {
            content = "Error processing XML, please try again.";
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response, String content, String xmlInput, String messageType) throws IOException {
        ...
        templateEngine.process("out-of-band", ctx, response.getWriter());
    }
}
